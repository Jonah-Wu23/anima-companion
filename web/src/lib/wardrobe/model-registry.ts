...
export const AVAILABLE_MODELS: ModelInfo[] = [
  {
    ...
    thumbnail: 'assets/model_photos/007.webp',
    tags: ['基础', '默认'],
    isAvailable: true,
    author: '流云景',
    priority: 1,
  },
  {
    ...
    pmxFile: '星穹铁道—白厄3.pmx',
    thumbnail: 'assets/model_photos/006.webp',
    tags: ['变身', '完整'],
    isAvailable: true,
    author: '流云景',
    priority: 2,
  },
  {
    ...
    thumbnail: 'assets/model_photos/002.webp',
    tags: ['变身', '外套'],
    isAvailable: true,
    author: 'FixEll',
    priority: 3,
  },
  {
    ...
    pmxFile: '德谬歌-白厄.pmx',
    thumbnail: 'assets/model_photos/004.webp',
    tags: ['变体', '粉色'],
    isAvailable: true,
    author: '苏酥鱼鱼喵',
    priority: 4,
  },
  {
    ...
    pmxFile: '铁墓白.pmx',
    thumbnail: 'assets/model_photos/001.webp',
    tags: ['变体', '红色'],
    isAvailable: true,
    author: '苏酥鱼鱼喵',
    priority: 5,
  },
  {
    ...
    pmxFile: '警服白厄2.pmx',
    thumbnail: 'assets/model_photos/003.webp',
    tags: ['制服', '警服'],
    isAvailable: true,
    author: '随着2时间的推移',
    priority: 6,
  ...
  },
  {
    ...
    pmxFile: '机长制服.pmx',
    thumbnail: 'assets/model_photos/008.webp',
    tags: ['制服', '机长'],
    isAvailable: true,
    author: '林槿',
    priority: 8,
  },
  {
    ...
    pmxFile: '瑞幸联动3.0.pmx',
    thumbnail: 'assets/model_photos/005.webp',
    tags: ['联动', '休闲'],
    isAvailable: true,
    author: '林槿',
    priority: 9,
  },
  {
    ...
    thumbnail: 'assets/model_photos/009.webp',
    tags: ['时尚', '杂志'],
    isAvailable: true,
    author: '林槿',
    priority: 10,
  },
  {
    ...
    thumbnail: 'assets/model_photos/013.webp',
    tags: ['娘化', '女神'],
    isAvailable: true,
    author: '填字小檀桌',
    priority: 11,
  },
  {
    ...
    thumbnail: 'assets/model_photos/012.webp',
    tags: ['娘化', '女神', '翅膀'],
    isAvailable: true,
    author: '填字小檀桌',
    priority: 12,
  },
  {
    ...
    pmxFile: '白厄短裙长发.pmx',
    thumbnail: 'assets/model_photos/011.webp',
    tags: ['女士', '短裙'],
    isAvailable: true,
    author: '填字小檀桌',
    priority: 13,
  },
  {
    ...
    directory: 'assets/models/Phainon_Lady/白厄女士 - 双版本',
    pmxFile: '白厄风衣长发.pmx',
    thumbnail: 'assets/model_photos/010.webp',
    tags: ['女士', '风衣'],
    isAvailable: true,
    author: '填字小檀桌',
    priority: 14,
  ...
  },
  {
    ...
    thumbnail: 'assets/model_photos/luotianyi-lihuaxue-11.webp',
    tags: ['换装', '古风'],
    isAvailable: true,
  ...
  },
  {
    ...
    thumbnail: 'assets/model_photos/luotianyi-mangzhong-figure.webp',
    tags: ['换装', '演出'],
    isAvailable: true,
    author: 'Samsink(机动战士牛肉）',
    priority: 103,
