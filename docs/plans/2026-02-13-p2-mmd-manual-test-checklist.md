...
**参考动作**: `xs-talk6-east-ë/.vmd` 或 `xs-talk8-east-渉.vmd`（Speaking 进入时随机）
...
### 3.2 Morph 名称验证
- [x] 打开 DevTools Console
- [x] 检查是否有 "Morph not found" 警告
- [x] 如有警告，记录实际的 Morph 名称
...
### 4.1 帧率监控
- [x] 打开 DevTools Performance
- [x] 录制 10 秒，观察 FPS
- [x] 桌面目标: >= 60 FPS

### 4.2 内存监控
- [x] 打开 DevTools Memory
- [x] 观察 JS Heap 大小
- [x] 目标: <= 200MB

### 4.3 加载时间
- [x] 打开 DevTools Network
- [x] 清空缓存刷新 (Ctrl+Shift+R)
- [x] 记录 PMX 文件加载时间
- [x] 目标: <= 5s (本地)
